...
class PersonDB {
  ...
  Future<bool> create(String firstName, String lastName) async {
    ...
    try {
      ...
      print("Error in catching person: ${e.toString()}");
      return false;
    }
  }
  ...
  Future<List<Person>> _fetchPeople() async {
    ...
    try {
      ...
      debugPrint('Error fetching people: ${e.toString()}');
      return [];
    }
  }
  ...
  Future<bool> update(Person person) async {
    ...
    try {
      ...
      print('Updating failed with error: ${e.toString()}');
      return false;
    }
  }
  ...
  Future<bool> delete(Person person) async {
    ...
    try {
      ...
      print('Deletion failed with error: ${e.toString()}');
      return false;
    }
  }
